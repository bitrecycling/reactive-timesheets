package de.bitrecycling.timeshizz.timetracking.repository;
...
public interface ActivityEntryRepository extends CrudRepository<ActivityEntryEntity, UUID> {
    ...
    List<ActivityEntryEntity> findActivityEntriesForProjectBetween(@Param("project") Project project, @Param("from") LocalDateTime from, @Param("to") LocalDateTime to);
    ...
    List<ActivityEntryEntity> findUsersActivityEntriesForProjectBetween(UUID userId, Project project, LocalDateTime from, LocalDateTime to);
    ...
    List<ActivityEntryEntity> findActivityEntriesForClientBetween(@Param("client") Client client, @Param("from") LocalDateTime from, @Param("to") LocalDateTime to);
    ...
    List<ActivityEntryEntity> findUsersActivityEntriesForClientBetween(UUID userId, Client client, LocalDateTime from, LocalDateTime to);
